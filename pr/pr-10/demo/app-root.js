...
`;class Ue extends b{static get styles(){return pt`
  ...
  `;f([S({type:String})],_.prototype,"value",void 0);f([S({type:String})],_.prototype,"placeholder",void 0);f([S({type:String})],_.prototype,"screenReaderLabel",void 0);f([S({type:String})],_.prototype,"clearButtonScreenReaderLabel",void 0);f([S({type:String})],_.prototype,"ariaControls",void 0);f([S({type:Boolean})],_.prototype,"focusOnClear",void 0);f([S({type:Boolean,reflect:!0})],_.prototype,"forceClearButton",void 0);f([Kt("#text-input")],_.prototype,"textInput",void 0);_=f([qt("ia-clearable-text-input")],_);let C=class extends b{constructor(){super(...arguments),this.lastInputResult="",this.lastClearResult="",this.lastSubmitResult=""}render(){var t;const i=(t=new URLSearchParams(window.location.search).get("query"))!==null&&t!==void 0?t:"";return vt`
