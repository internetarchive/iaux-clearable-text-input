 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function $t(n){return b({...n,state:!0})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2019 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const F=window,ft=F.ShadowRoot&&(F.ShadyCSS===void 0||F.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,Ft=Symbol(),Ut=new WeakMap;class $e{constructor(t,e,i){if(this._$cssResult$=!0,i!==Ft)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=t,this.t=e}get styleSheet(){let t=this.o;const e=this.t;if(ft&&t===void 0){const i=e!==void 0&&e.length===1;i&&(t=Ut.get(e)),t===void 0&&((this.o=t=new CSSStyleSheet).replaceSync(this.cssText),i&&Ut.set(e,t))}return t}toString(){return this.cssText}}const fe=n=>new $e(typeof n=="string"?n:n+"",void 0,Ft),_e=(n,t)=>{ft?n.adoptedStyleSheets=t.map(e=>e instanceof CSSStyleSheet?e:e.styleSheet):t.forEach(e=>{const i=document.createElement("style"),s=F.litNonce;s!==void 0&&i.setAttribute("nonce",s),i.textContent=e.cssText,n.appendChild(i)})},kt=ft?n=>n:n=>n instanceof CSSStyleSheet?(t=>{let e="";for(const i of t.cssRules)e+=i.cssText;return fe(e)})(n):n;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
`;class Ue extends w{static get styles(){return pt`
      :host {
    ...
    `}render(){return Pe}}customElements.define("ia-icon-close",Ue);let _=class extends w{constructor(){super(...arguments),this.value="",this.clearButtonScreenReaderLabel="Clear",this.focusOnClear=!0,this.forceClearButton=!1}render(){var t,e,i,s;const o=!this.value&&!this.forceClearButton;return vt`
      <div id="container">
        <slot name="icon"></slot>
        <input
          id="text-input"
  ...
  `;f([b({type:String})],_.prototype,"value",void 0);f([b({type:String})],_.prototype,"placeholder",void 0);f([b({type:String})],_.prototype,"screenReaderLabel",void 0);f([b({type:String})],_.prototype,"clearButtonScreenReaderLabel",void 0);f([b({type:String})],_.prototype,"ariaControls",void 0);f([b({type:Boolean})],_.prototype,"focusOnClear",void 0);f([b({type:Boolean,reflect:!0})],_.prototype,"forceClearButton",void 0);f([Kt("#text-input")],_.prototype,"textInput",void 0);_=f([qt("ia-clearable-text-input")],_);let C=class extends w{constructor(){super(...arguments),this.lastInputResult="",this.lastClearResult="",this.lastSubmitResult=""}render(){var t;const i=(t=new URLSearchParams(window.location.search).get("query"))!==null&&t!==void 0?t:"";return vt`
  ...
  `;f([$t()],C.prototype,"lastInputResult",void 0);f([$t()],C.prototype,"lastClearResult",void 0);f([$t()],C.prototype,"lastSubmitResult",void 0);f([Kt("ia-clearable-text-input")],C.prototype,"widget",void 0);C=f([qt("app-root")],C);
