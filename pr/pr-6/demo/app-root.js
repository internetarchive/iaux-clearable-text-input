...
`;class Ue extends E{static get styles(){return pt`
      :host {
    ...
    `}render(){return Pe}}customElements.define("ia-icon-close",Ue);let f=class extends E{constructor(){super(...arguments),this.value="",this.clearButtonScreenReaderLabel="Clear",this.focusOnClear=!0}render(){var t,e,i,s;const o=!this.value;return vt`
      <div id="container">
        <input
          id="text-input"
          type="text"
  ...
  `;_([C({type:String})],f.prototype,"value",void 0);_([C({type:String})],f.prototype,"placeholder",void 0);_([C({type:String})],f.prototype,"screenReaderLabel",void 0);_([C({type:String})],f.prototype,"clearButtonScreenReaderLabel",void 0);_([C({type:String})],f.prototype,"ariaControls",void 0);_([C({type:Boolean})],f.prototype,"focusOnClear",void 0);_([Kt("#text-input")],f.prototype,"textInput",void 0);f=_([qt("ia-clearable-text-input")],f);let w=class extends E{constructor(){super(...arguments),this.lastInputResult="",this.lastClearResult="",this.lastSubmitResult=""}render(){var t;const i=(t=new URLSearchParams(window.location.search).get("query"))!==null&&t!==void 0?t:"";return vt`
